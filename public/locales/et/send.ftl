...
sendYourFilesLink = Proovi bytefile'i
...
notSupportedOutdatedDetail = Kahjuks ei toeta see Firefoxi versioon veebitehnoloogiaid, mis teevad bytefilei toimimise võimalikuks. Sa pead oma brauserit uuendama.
...
javascriptRequired = bytefile'i kasutamiseks tuleb JavaScript lubada
whyJavascript = Miks bytefile JavaScripti vajab?
