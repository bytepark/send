...
sendYourFilesLink = Experimentar o bytefile
...
notSupportedOutdatedDetail = Infelizmente esta versão do Firefox não suporta a tecnologia web que faz o bytefile funcionar. Precisa de atualizar o seu navegador.
...
javascriptRequired = O bytefile requer JavaScript
whyJavascript = Porque é que o bytefile requer JavaScript?
