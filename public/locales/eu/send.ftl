...
sendYourFilesLink = Probatu bytefile
...
notSupportedOutdatedDetail = Zoritxarrez Firefox bertsio honek ez du bytefile-ek behar duen web teknologia onartzen. Zure nabigatzailea eguneratu behar duzu.
...
javascriptRequired = JavaScript beharrezkoa da bytefile erabiltzeko.
whyJavascript = Zergatik behar du bytefile-ek JavasScript?
