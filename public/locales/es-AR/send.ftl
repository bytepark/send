...
sendYourFilesLink = Probá bytefile
...
notSupportedOutdatedDetail = Desafortunadamente esta versión de Firefox no soporta la tecnología web que necesita bytefile. Necesitás actualizar el navegador.
...
whyJavascript = ¿Por qué bytefile requiere Java Script?
