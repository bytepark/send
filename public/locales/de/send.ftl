...
notSupportedOutdatedDetail = Leider unterstützt diese Firefox-Version die Web-Technologie nicht, auf der { $title } basiert. Du musst deinen Browser aktualisieren.
...
javascriptRequired = { $title } benötigt JavaScript
whyJavascript = Warum benötigt { $title } JavaScript?
