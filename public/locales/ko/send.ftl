...
sendYourFilesLink = bytefile 써보기
...
notSupportedOutdatedDetail = 안타깝게도 사용중인 Firefox 버전에서는 bytefile에 사용되는 웹 기술을 지원하지 않습니다. 브라우 업데이트가 필요합니다.
...
javascriptRequired = bytefile는 자바스크립트를 필요로 합니다
whyJavascript = 왜 bytefile에 자바스크립트가 필요하죠?
