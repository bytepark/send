...
sendYourFilesLink = bytefile wopytaś
...
notSupportedOutdatedDetail = Bóžko toś ta wersija Firefox webtechnologiju njepódpěra, na kótarejž bytefile bazěrujo. Musyśo swój wobglědowak aktualizěrowaś.
...
whyJavascript = Cogodla bytefile JavaScript trjeba?
