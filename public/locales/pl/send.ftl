...
sendYourFilesLink = Wypróbuj bytefile
...
notSupportedOutdatedDetail = Ta wersja Firefoksa nie obsługuje technologii internetowej, która napędza bytefile. Należy uaktualnić przeglądarkę.
...
javascriptRequired = bytefile wymaga języka JavaScript
whyJavascript = Dlaczego bytefile wymaga języka JavaScript?
