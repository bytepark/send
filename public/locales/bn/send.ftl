...
sendYourFilesLink = bytefile পরখ করে দেখুন
...
notSupportedOutdatedDetail = দুর্ভাগ্যবশত Firefox এই সংস্করণটি ওয়েব প্রযুক্তিকে সমর্থন করে না যা bytefile কে সমর্থন করে। আপনাকে আপনার ব্রাউজারটি আপডেট করতে হবে।
...
javascriptRequired = bytefile এর জাভাস্ক্রিপ্ট প্রয়োজন।
whyJavascript = কেন bytefile এর জাভাস্ক্রিপ্ট প্রয়োজন?
...
introDescription = { -send-brand } ফাইল এনক্রিপশন ও স্বয়ংক্রিয়ভাবে মেয়াদ শেষ হবে এমন একটি লিঙ্কের মাধ্যমে শুরু-থেকে-শেষ পর্যন্ত শেয়ার করতে দেয়। একারণে আপনি যা শেয়ার করেন তা গোপন রাখতে এবং আপনার জিনিস চিরদিনের জন্য অনলাইনে থাকবে া তা নিশ্চিত করতে পারেন।
...
notSupportedDescription = { -send-brand } এই ব্রাউজারের সাথে কাজ করবে না। { -firefox } এর সাম্প্রতিকতম সংস্করণে { -send-short-brand } সর্বোত্তমভাবে কাজ করবে, এবং এটি বেশিরভাগ বরাউজারের বর্তমান সংস্করণে কাজ করবে।
...
accountBenefitDownloadCount = আরও মানুষের সাথে ফাইল শেয়া করুন
...
noStreamsOptionFirefox = আমাদের জনপ্রিয় ব্রউজার ব্যবহার করুন
