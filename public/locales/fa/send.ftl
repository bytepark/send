...
sendYourFilesLink = bytefile را امتحان کنید
...
notSupportedOutdatedDetail = متاسفانه این نسخه از فایرفاکس این تکنولوژی وب که به bytefile قدرت می‌بخشد را پشتیبانی نمی‌کند. شما نیاز دارید تا مرورگر خود را بروز کنید.
...
javascriptRequired = bytefile نیازمند جاوااسکریپت است
whyJavascript = چرا bytefile جاوااسکریپت لازم داد؟
