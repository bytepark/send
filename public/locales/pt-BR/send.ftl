...
sendYourFilesLink = Experimente o bytefile
...
notSupportedOutdatedDetail = Infelizmente essa versão do Firefox não suporta a tecnologia web que faz o bytefile funcionar. Você precisa atualizar o seu navegador.
...
whyJavascript = Por que o bytefile precisa do JavaScript?
