...
sendYourFilesLink = Pecakan bytefile
...
notSupportedOutdatedDetail = Hanjakal Firefox vérsi ieu teu ngarojong téhnologi wéb nu ngagerakkeun bytefile. Anjeun perlu ngapdét panyungsi anjeun.
...
javascriptRequired = bytefile merlukeun JavaScript
whyJavascript = Naha bytefile merlukeun JavaScript?
