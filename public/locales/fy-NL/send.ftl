...
sendYourFilesLink = bytefile probearje
...
notSupportedOutdatedDetail = Spitigernôch stipet dizze ferzje fan Firefox de webtechnology dy't bytefile mooflik makket net. Jo moatte jo browser fernije.
...
javascriptRequired = bytefile fereasket JavaScript.
whyJavascript = Werom hat bytefile JavaScript nedich?
