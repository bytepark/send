...
sendYourFilesLink = Proveu el bytefile
...
notSupportedOutdatedDetail = Aquesta versió del Firefox no admet la tecnologia web amb què funciona el bytefile. Haureu d'actualitzar el navegador.
...
javascriptRequired = El bytefile necessita JavaScript
whyJavascript = Per què el bytefile necessita JavaScript?
