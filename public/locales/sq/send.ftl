...
sendYourFilesLink = Provoni bytefile
...
notSupportedOutdatedDetail = Mjerisht, ky version i Firefox-it nuk e mbulon teknologjinë web mbi të cilën bazohet bytefile. Do t’ju duhet të përditësoni shfletuesin tuaj.
...
javascriptRequired = bytefile lyp JavaScript
whyJavascript = Ç’i duhet bytefile-it JavaScript-i?
