...
notSupportedOutdatedDetail = 很可惜，此版本的 Firefox 不支援 bytefile 所需的 Web 技術。請更新瀏覽器後再使用。
...
javascriptRequired = bytefile 需要開啟 JavaScript 功能
whyJavascript = 為什麼 bytefile 需要 JavaScript 才能使用？
