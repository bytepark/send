...
sendYourFilesLink = გამოცადეთ bytefile
errorPageHeader = რაღაც ხარვეზია!
fileTooBig = ფაილი ზედმეტა დიდია. უნდა იყოს { $size } ზომაზე ნაკლები.
...
notSupportedOutdatedDetail = სამწუხაროდ, Firefox-ის ამ ვერსიას არ გააჩნია ის ტექნოლოგია, რომელიც აუცილებელია bytefile-ის მუშაობისთვის. გესაჭიროებათ, ბრაუზერის განახლება.
...
javascriptRequired = bytefile საჭიროებს JavaScript-ს
whyJavascript = რატომ საჭიროებს bytefile JavaScript-ს?
...
introDescription = { -send-brand } საშუალებას გაძლევთ გააზიაროთ ფაილები გამჭოლი დაშიფვრითა და ბმულით, რომელიც გარკვეული დროის შემდეგ თავისთავად გაუქმდება. ასე რომ, რასაც გააზიარებთ იქნება საიდუმლო და არც ინტერნეტში არ დარჩება სამუდამო.
...
tooManyFiles =
    { $count ->
        [one] მხოლოდ 1 ფაილი შეიძლება აივირთოს ერთ ჯერზე.
...
legalTitle = { -send-short-brand } პირადულობის განაცხდი
...
accountBenefitSync = მართეთ გაზიარებული ფაილები ნებიმიერი მოწყობილობიდან
