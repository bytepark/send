...
# bytefile is a brand name and should not be localized.
downloadMessage = Vaš prijatelj vam je poslao datoteku preko usluge bytefile koja vam omogućava da dijelite datoteke preko sigurne, privatne i šifrovane veze koja samostalno ističe da vaše stvari ne ostanu zauvijek na internetu.
...
# bytefile is a brand name and should not be localized.
sendYourFilesLink = Probajte bytefile
...
notSupportedHeader = Vaš pretraivač nije podržan.
# bytefile is a brand name and should not be localized.
notSupportedDetail = Ovaj pretraživač nažalost ne podržava web tehnologiju koja omogućava bytefile. Trebate probati drugi pretraživač. Preporučujemo Firefox!
notSupportedLink = Zašto moj pretraživač nije podržan?
notSupportedOutdatedDetail = Nažalost ova verzija Firefoxa ne podržava web tehnologiju koja omogućava bytefile. Morate ažurirati vaš pretraživač.
...
legalNoticeTestPilot = bytefile je trenutno Test Pilot eksperiment i podržan je <a>uslovima korištenja</a> i <a>obavještenjem o privatnosti</a>. Možete saznati više o ovom eksperimentu i o njegovom sakupljanju podataka <a>ovdje</a>.
legalNoticeMozilla = Korištenje bytefile web stranice podlaže Mozillinom <a>obavještenju o privatnosti na web stranicama</a> i <a>uslovima korištenja web stranica</a>.
...
javascriptRequired = bytefile zahtjeva JavaScript
whyJavascript = Zašto bytefile zahtjeva JavaScript?
