...
notSupportedOutdatedDetail = Dessverre støtter ikke denne versjonen av Firefox netteknologien som driver bytefile. Du trenger å oppdatere nettleseren din.
...
javascriptRequired = bytefile krever JavaScript.
whyJavascript = Hvorfor krever bytefile JavaScript?
